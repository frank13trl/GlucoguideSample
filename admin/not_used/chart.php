...
if (mysqli_connect_error()) {
            ...
            $result = mysqli_query($handle, "SELECT * FROM(Select * from patient_reading where patient_id='$pid' AND pricked!='0' ORDER BY action_taken DESC LIMIT 10)Var1 ORDER BY action_taken ASC;");
